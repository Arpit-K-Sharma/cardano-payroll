...
const SUPPORTED_WALLETS = [
  {
    ...
    name: 'Nami',
    icon: '🦊',
    checkAvailable: () => typeof window !== 'undefined' && 'cardano' in window && 'nami' in window.cardano,
  },
  {
    id: 'eternl',
    name: 'Eternl',
    icon: '🦋',
    checkAvailable: () => typeof window !== 'undefined' && 'cardano' in window && 'eternl' in window.cardano,
  },
]
...
export function WalletConnect() {
  ...
  return (
    <Card className="p-8 max-w-md mx-auto shadow-2xl border-2 border-primary/30 bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
